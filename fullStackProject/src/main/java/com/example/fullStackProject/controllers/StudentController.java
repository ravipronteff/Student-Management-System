...
import com.example.fullStackProject.model.LoginValidation;
...
public class StudentController {
	...
	@GetMapping("/loging")
	public String validateLoginCredentials(@ModelAttribute("adminObj")LoginValidation adminDetails) {
		if(adminDetails.getEmail().equals("mthriveni565@gmail.com")&& adminDetails.getPassword().equals("abcd")) {
			return "redirect:/seeallstudents";
		}
		else {
			return "login";
